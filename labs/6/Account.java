...
public class Account {
  ...
  public static void main(String[] args) {
    ...
    a.deposit(3000);
    //Display results
    System.out.println("The balance in the account is " + a.getBalance() + ", the monthly interest is " + a.getMonthlyInterest() + ", and the date it was created is " + a.getDateCreated());
  }
}
